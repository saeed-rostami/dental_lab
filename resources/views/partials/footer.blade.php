    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                ...
                <a class="navbar-brand logo-h d-none d-xl-block" href="index.html"><img src="pics/logo.png" alt=""></a>
            </div>
            <div class="col-xl-6 col-sm-6 mb-4 mb-xl-0 single-footer-widget">
                <h4>اطلاعات تماس</h4>
                <ul>
                    ...
                    <li>شماره همراه : {{ $setting->mobile }}</li>
        ...
        <div class="footer-bottom row align-items-center text-center text-lg-right">
            ...
            <div class="col-lg-4 col-md-12 text-center text-lg-left footer-social">
                ...
                <a target="_blank" href="http://telegram.com/{{$setting->telegram}}">
                ...
                <a target="_blank" href="http://whatsapp.com/{{$setting->whatsapp}}">
